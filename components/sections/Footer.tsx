    ...
    >
      <div className="flex flex-col sm:flex-row w-full justify-between items-end border-b border-white/20 pb-12">
        <div className="flex flex-col gap-6">
          ...
          <Magnetic>
            <a href="mailto:hello@example.com" className="text-xl sm:text-2xl text-gray-300 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white rounded">
              hello@example.com
            </a>
          </Magnetic>
        </div>
        
        <div className="mt-12 sm:mt-0 flex gap-12 text-sm uppercase tracking-widest text-gray-300">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between pt-8 text-xs text-gray-300 tracking-widest uppercase">
