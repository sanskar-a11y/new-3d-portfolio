        ...
        return (
          <motion.span
            ...
            className={`inline-block transition-colors duration-300 ${
              isHighlight ? 'text-white/75 font-thin italic' : 'text-white'
            }`}
          >
            {word}
          </motion.span>
...
export function About() {
  ...
  return (
    ...
    >
      ...
      ═══════════════════════════════════════════════ */}
      <section className="min-h-[75vh] sm:min-h-[85vh] flex flex-col justify-center items-center px-5 sm:px-10 lg:px-20 pt-8 sm:pt-16 pb-12 sm:pb-20">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            ...
            <p className="uppercase tracking-[0.35em] text-white/75 text-[11px] sm:text-xs font-light">
              About // Sanskar
            </p>
          </motion.div>
          ...
          <h1 className="text-[clamp(3rem,8.5vw,7.5rem)] font-extralight leading-[0.98] tracking-tighter text-white text-center w-full">
            ...
            <motion.span
              ...
              className="block text-white/75 font-thin italic mt-3 sm:mt-5"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 max-w-6xl">
          ...
          <motion.div style={{ y: yParallax }} className="lg:col-span-9 max-w-2xl flex flex-col gap-10">
            ...
            <ElegantText delay={0.1}>
              <p className="text-base sm:text-lg font-light text-white/90 leading-[1.85]">
            ...
            <ElegantText delay={0.15}>
              <div className="pl-6 border-l border-white/30 space-y-2 py-1">
                <p className="text-sm sm:text-base font-light text-white/95 leading-[1.9]">
      ...
      <section className="px-5 sm:px-10 lg:px-20 py-14 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 max-w-6xl">
          ...
          <div className="lg:col-span-9 max-w-2xl flex flex-col gap-10">
            ...
            <ElegantText delay={0.15}>
              <div className="pl-6 border-l border-white/30 space-y-3 py-1">
                <div className="text-xs font-mono uppercase tracking-[0.3em] text-white font-light">
                  Observe · Understand · Adapt · Execute
                </div>
                <p className="text-sm sm:text-base font-light text-white/85 italic leading-[1.85]">
      ...
      <section className="px-5 sm:px-10 lg:px-20 py-14 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 max-w-6xl">
          ...
          <div className="lg:col-span-9 max-w-2xl flex flex-col gap-10">
            ...
            <ElegantText delay={0.1}>
              <p className="text-sm sm:text-[15px] font-light text-white/85 leading-[1.95]">
                My projects are where experimentation turns into something tangible. I&apos;ve worked across <span className="text-white">web development, AI-assisted development, automation, interactive interfaces, creative coding, and digital experiences</span> — constantly experimenting with new tools and approaches.
              </p>
            </ElegantText>
            ...
            <ElegantText delay={0.2}>
              <div className="space-y-2">
                ...
                <p className="text-xs uppercase tracking-[0.25em] text-white/75 font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 max-w-6xl">
          ...
          <div className="lg:col-span-9 max-w-2xl flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5 py-2">
              {AMBITION_ITEMS.map((item, idx) => (
                <ElegantText key={idx} delay={0.12 + idx * 0.05}>
                  <div className="group flex flex-col sm:flex-row sm:items-baseline justify-between gap-1 py-2 border-b border-white/[0.1] transition-colors">
            ...
            <ElegantText delay={0.25}>
              <p className="text-sm sm:text-[15px] font-light text-white/95 leading-[1.95]">
                I don&apos;t expect to know everything. I expect to be able to <span className="text-white font-medium underline decoration-white/50 underline-offset-4">learn whatever I need next.</span>
              </p>
            </ElegantText>
          </div>
        </div>
      ...
      <section className="px-5 sm:px-10 lg:px-20 py-14 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 max-w-6xl">
          ...
          <div className="lg:col-span-9 max-w-2xl flex flex-col gap-10">
            ...
            <ElegantText delay={0.1}>
              <p className="text-sm sm:text-[15px] font-light text-white/85 leading-[1.95]">
                That&apos;s why my interests extend beyond code. I&apos;m fascinated by <span className="text-white">psychology, human behavior, AI, automation, design, systems, and the way people make decisions</span>.
              </p>
            </ElegantText>
              ...
              <div className="flex flex-wrap items-baseline gap-x-6 gap-y-4">
                {CAPABILITIES.map((skill, idx) => (
                  <motion.span
                    ...
                    className="text-sm sm:text-base font-light text-white/80 hover:text-white transition-colors cursor-default select-none tracking-wide"
                  >
                    {skill}
                    {idx < CAPABILITIES.length - 1 && (
                      <span className="text-white/30 ml-6 select-none font-thin">/</span>
                    )}
                  </motion.span>
                ))}
              </div>
          ...
          <div className="lg:col-span-9 max-w-2xl flex flex-col gap-6">
            {CERTIFICATES.map((cert, idx) => (
              <ElegantText key={idx} delay={idx * 0.06}>
                <div className="group flex flex-col sm:flex-row sm:items-baseline justify-between gap-1 py-3 border-b border-white/[0.1] transition-colors">
                  ...
                  <p className="text-xs font-mono uppercase tracking-[0.15em] text-white/70">
                    {cert.org}
                  </p>
                </div>
              </ElegantText>
